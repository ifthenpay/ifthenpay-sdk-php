...
try {
    ...
    $storedPayment  = new Cofidis('0.50', '01', 'tid111111111111', 'https://exampleurl.com', Status::PENDING, null);
    $webhookRequest = new WebhookRequest('0.50', '01', 'a0a0a0a0a0a0aa0a0a0a', 'tid111111111111');

    $ifthenpayGateway->cofidis()->validateWebhook($webhookRequest, $storedPayment);
